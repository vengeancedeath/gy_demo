...
#define TASK_INFO(format, ...) LOG_INFO(log_tag, format, ##__VA_ARGS__)
...
void freertos_start(void)
{
  ...
  {
    //打印
    TASK_INFO("start_task create failed");
    return;
  }
